...
class QuestionsActivity : AppCompatActivity() , View.OnClickListener{
    ...
    private var selectedOptionPostion = 0
    ...
    private fun checkAnswer() {
        ...
        if (selectedAnswer == currentQuestion.correctAnswer) {
            ...
            when (selectedAnswer) {
                1 -> {
                    textViewOptionOne.background = ContextCompat.getDrawable(this, R.drawable.wrong_border_bg)
                }
                2 -> {
                    textViewOptionTwo.background = ContextCompat.getDrawable(this, R.drawable.wrong_border_bg)
                }
                3 -> {
                    textViewOptionThree.background = ContextCompat.getDrawable(this, R.drawable.wrong_border_bg)
                }
                4 -> {
                    textViewOptionFour.background = ContextCompat.getDrawable(this, R.drawable.wrong_border_bg)
                }
            }
        }
    ...
    private fun highlightAnswer(anser: Int) {
        when (anser) {
            1 -> {
                textViewOptionOne.background = ContextCompat.getDrawable(this, R.drawable.correct_border_bg)
            }
            2 -> {
                textViewOptionTwo.background = ContextCompat.getDrawable(this, R.drawable.correct_border_bg)
            }
            3 -> {
                textViewOptionThree.background = ContextCompat.getDrawable(this, R.drawable.correct_border_bg)
            }
            4 -> {
                textViewOptionFour.background = ContextCompat.getDrawable(this, R.drawable.correct_border_bg)
            }
        }
    }
